...
import { Mail, Send, CheckCircle, Loader2, Phone as PhoneIcon } from "lucide-react";
    ...
    <div className="min-h-screen">
      <section className="py-14 sm:py-20 bg-gradient-section">
        <div className="container mx-auto px-4 text-center">
          <Mail className="h-8 sm:h-10 w-8 sm:w-10 text-primary mx-auto mb-4" />
          <h1 className="font-display text-3xl sm:text-5xl md:text-6xl font-bold mb-4">Contact Us</h1>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 max-w-xl">
          <div className="rounded-2xl border border-border bg-card p-8">
            ...
            <p className="text-muted-foreground text-sm mb-4">We'll respond as quickly as possible.</p>
            <a
              href="tel:9362380102"
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div>
                    ...
                    <input
                      required name="name" type="text" maxLength={100}
                  ...
                  <div>
                    ...
                    <input
                      required name="email" type="email" maxLength={255}
                      className="w-full px-4 py-2.5 rounded-lg bg-background border border-border text-foreground text-sm focus:outline-none focus:ring-2 focus:ring-primary/50"
                    />
                  </div>
                </div>
                <div>
                  ...
                  <input
                    name="phone" type="tel" maxLength={30}
                    className="w-full px-4 py-2.5 rounded-lg bg-background border border-border text-foreground text-sm focus:outline-none focus:ring-2 focus:ring-primary/50"
                  />
                </div>
                <div>
                  ...
                  <textarea
                    required name="message" rows={5} maxLength={2000}
